...
local token = '425412319:AAEbwwXsd5Lmj1kRnmbcLo8FnCXjeIESwgQ'  --[[Enter tokn here]]
local url = 'https://api.telegram.org/bot' .. token
local offset = 0
local SUDO = 241619708   --[[Enter your id here]]
local redis = require('redis')
local redis = redis.connect('127.0.0.1', 6379)
function is_mod(chat,user)
	sudo = {415514776,241619708,000000000,000000000,000000000}  --[[Enter your id and cli bot id here]]
 local var = false
  ...
  while true do
    ...
    if(updates) then
      if (updates.result) then
		...
		if q.from.id == 415514776 or q.from.id == 241619708 then
